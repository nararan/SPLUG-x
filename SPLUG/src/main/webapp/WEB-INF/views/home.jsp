...
<head>
    ...
    <!-- Morris Charts CSS -->
    <link href="resources/bootstrap/vendor/morrisjs/morris.css" rel="stylesheet">
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">SPLUG</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="notification"><i class="fa fa-dashboard fa-fw"></i>공지사항</a>
                        </li>
                        <li>
                            <a href="agora"><i class="fa fa-bar-chart-o fa-fw"></i>자유게시판</a>                       
                        </li>
                        <li>
                            <a href="galary"><i class="fa fa-table fa-fw"></i>갤러리</a>
                        </li>
                        <li>
                            <a href="data"><i class="fa fa-edit fa-fw"></i>자료실</a>
                        </li>
                        <li>
                            <a href="recruit"><i class="fa fa-wrench fa-fw"></i>선배의 리크루팅</a>                          
                        </li>
